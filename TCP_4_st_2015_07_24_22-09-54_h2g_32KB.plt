...
set output "TCP_4_st_2015_07_24_22-09-54_h2g_32KB.png"

set title "{/=20 Buffer size: 32 KB, Av. rate: 5.73 Gb/s}\n\n{/=18 (Host to Guest, TCP, 4 st.)}"
...
plot "TCP_4_st_2015_07_24_22-09-54_h2g_32KB_iperf_processed.dat" using 1:($2/1073741824.0-$3/1073741824.0):($2/1073741824.0+$3/1073741824.0) with filledcurves lc rgb "blue" notitle, \
     "" using 1:($2/1073741824.0) with points pt 2 ps 1.5 lw 3 lc rgb "blue" title "Mean tot. BW", \
     "TCP_4_st_2015_07_24_22-09-54_h2g_32KB_mpstat_processed.dat" using 1:($2-$3):($2+$3) with filledcurves lc rgb "red" axes x1y2 notitle, \
